...
import vn.edu.hcmus.mentor.backend.controller.usecase.note.common.NoteUserProfileProjection;
import vn.edu.hcmus.mentor.backend.domain.User;
import vn.edu.hcmus.mentor.backend.domain.constant.UserRole;
import vn.edu.hcmus.mentor.backend.repository.custom.UserCustomRepository;
