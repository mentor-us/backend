...
import vn.edu.hcmus.mentor.backend.controller.payload.ApiResponseDto;
import vn.edu.hcmus.mentor.backend.controller.payload.ReturnCodeConstants;
import vn.edu.hcmus.mentor.backend.controller.payload.request.groups.AddMembersRequest;
import vn.edu.hcmus.mentor.backend.controller.payload.response.ShortMediaMessage;
import vn.edu.hcmus.mentor.backend.controller.payload.response.groups.GroupMembersResponse;
import vn.edu.hcmus.mentor.backend.controller.payload.response.groups.UpdateGroupAvatarResponse;
import vn.edu.hcmus.mentor.backend.controller.usecase.channel.common.ChannelForwardDto;
import vn.edu.hcmus.mentor.backend.controller.usecase.channel.getchannelbyid.GetChannelByIdQuery;
import vn.edu.hcmus.mentor.backend.controller.usecase.channel.getchannelforward.GetChannelsForwardQuery;
import vn.edu.hcmus.mentor.backend.controller.usecase.channel.getmediabychannelid.GetMediaByChannelIdQuery;
import vn.edu.hcmus.mentor.backend.controller.usecase.common.DetailDto;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.addmembertogroup.AddMemberToGroupCommand;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.common.GroupDetailDto;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.creategroup.CreateGroupCommand;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.enabledisablestatusgroupbyid.EnableDisableGroupByIdCommand;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.getallgroups.GetAllGroupsQuery;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.getgroupbyid.GetGroupByIdQuery;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.getgroupworkspace.GetGroupWorkSpaceQuery;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.gethomepage.GetHomePageQuery;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.gethomepage.HomePageDto;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.importgroup.ImportGroupCommand;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.promotedemoteuser.PromoteDenoteUserByIdCommand;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.removemembergroup.RemoveMemberToGroupCommand;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.searchowngroups.SearchOwnGroupsQuery;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.serachgroups.SearchGroupsQuery;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.togglemarkmentee.ToggleMarkMenteeCommand;
import vn.edu.hcmus.mentor.backend.controller.usecase.group.updategroupbyid.UpdateGroupByIdCommand;
import vn.edu.hcmus.mentor.backend.domain.Group;
import vn.edu.hcmus.mentor.backend.domain.constant.GroupStatus;
import vn.edu.hcmus.mentor.backend.domain.constant.GroupUserRole;
import vn.edu.hcmus.mentor.backend.security.principal.CurrentUser;
...
import vn.edu.hcmus.mentor.backend.service.dto.GroupServiceDto;
...
import static vn.edu.hcmus.mentor.backend.controller.payload.ReturnCodeConstants.INVALID_PERMISSION;
