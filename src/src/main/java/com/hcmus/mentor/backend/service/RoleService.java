...
public class RoleService {
    ...
    public RoleService(RoleRepository roleRepository, PermissionService permissionService, PermissionRepository permissionRepository, UserRepository userRepository) {
