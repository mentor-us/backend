...
public class MessageDetailResponse {
    ...
    public static MessageDetailResponse totalReaction(MessageDetailResponse message, String viewerId) {
    ...
    public static Integer calculateTotalReactionAmount(List<Reaction> reactions) {
        return reactions.stream().map(Reaction::getTotal)
    ...
    public static class TotalReaction {
        ...
        @Builder.Default
        private List<Emoji> ownerReacted = new ArrayList<>();
