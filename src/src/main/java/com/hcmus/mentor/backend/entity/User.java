...
public class User implements Serializable {
  ...
  @Builder.Default private String imageUrl = "";

  @Builder.Default private String wallpaper = "";

  @Builder.Default private Boolean emailVerified = true;

  @Builder.Default private String password = "";

  @NotNull @Builder.Default private AuthProvider provider = AuthProvider.local;
  ...
  @Builder.Default private String personalEmail = "";

  @Builder.Default private Gender gender = Gender.MALE;

  @Builder.Default private List<String> groupIds = new ArrayList<>();

  @Builder.Default private List<String> pinnedGroupsId = new ArrayList<>();

  @Builder.Default private List<Role> roles = new ArrayList<>(Arrays.asList(USER));
