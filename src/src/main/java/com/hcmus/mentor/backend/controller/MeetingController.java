...
public class MeetingController {
    ...
    public MeetingController(MeetingService meetingService, GroupService groupService, MeetingRepository meetingRepository, PermissionService permissionService, MessageService messageService, SocketIOServer socketServer, UserRepository userRepository, NotificationService notificationService) {
    ...
    @Operation(summary = "All Meetings of Group", description = "Get all meetings of group", tags = "Meeting APIs")
    @ApiResponses({
    ...
    @Operation(summary = "Create New Meeting in Group", description = "Create a new meeting in group", tags = "Meeting APIs")
    @ApiResponses({
    ...
    @Operation(summary = "Update Meeting in Group", description = "Update a existing meeting in group", tags = "Meeting APIs")
    @ApiResponses({
    ...
    @Operation(summary = "Delete Meeting in Group", description = "Remove a existing meeting in group", tags = "Meeting APIs")
    @ApiResponses({
    ...
    @Operation(summary = "Get meeting detail of group", description = "Retrieve detail information of meeting group", tags = "Meeting APIs")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Removed successfully",
                    content = @Content(array = @ArraySchema(schema = @Schema(implementation = APIResponse.class)))
            ),
    ...
    @Operation(summary = "Get meeting attendees of group", description = "Retrieve all information about attendess of meeting group", tags = "Meeting APIs")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Removed successfully",
                    content = @Content(array = @ArraySchema(schema = @Schema(implementation = APIResponse.class)))
            ),
    ...
    @Operation(summary = "Reschedule Meeting in Group",
            description = "Reschedule a existing meeting to another time in group", tags = "Meeting APIs")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Reschedule successfully",
                    content = @Content(array = @ArraySchema(schema = @Schema(implementation = APIResponse.class)))
            ),
            @ApiResponse(responseCode = "401", description = "Need authentication")
    })
