...
public class GoogleDriveManager {
    ...
    public String getFolderIdByName(String parentId, String folderName) throws GeneralSecurityException, IOException {
    ...
    public File uploadToFolder(String folderName, MultipartFile file)
        ...
        File uploadedFile = service.files().create(fileMetadata,
