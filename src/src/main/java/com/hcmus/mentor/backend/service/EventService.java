...
public class EventService {
    ...
    public EventService(MeetingService meetingService, TaskService taskService, MeetingRepository meetingRepository, TaskRepository taskRepository) {
    ...
    public List<Event> getMostRecentEvents(String userId) {
        ...
        return Stream.concat(meetings.stream().map(Event::from),
                        tasks.stream().map(Event::from))
    ...
    public static class Event {
        ...
        public Date getUpcomingTime() {
            return (EventService.EventType.TASK.equals(getType()))
                    ? getDeadline()
                    : getTimeStart();
        }
