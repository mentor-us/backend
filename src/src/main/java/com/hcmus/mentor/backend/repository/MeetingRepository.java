...
public interface MeetingRepository extends MongoRepository<Meeting, String> {
    ...
    List<Meeting> findAllByOrganizerIdAndTimeStartGreaterThanOrAttendeesInAndTimeStartGreaterThanOrderByTimeStartDesc(String organizerId, Date date, List<String> ids, Date now);

    List<Meeting> findAllByOrganizerIdAndTimeStartGreaterThan(String organizerId, Date date);

    List<Meeting> findAllByAttendeesInAndTimeStartGreaterThanOrderByTimeStartAsc(List<String> ids, Date now);
    ...
    Page<Meeting> findAllByGroupIdInAndOrganizerIdAndTimeStartGreaterThanOrGroupIdInAndAttendeesInAndTimeStartGreaterThan(List<String> groupIds, String userId, Date startDate, List<String> groupId, List<String> ids, Date date, PageRequest pageRequest);

    List<Meeting> findAllByGroupIdInAndOrganizerIdOrGroupIdInAndAttendeesIn(List<String> activeGroupIds, String id, List<String> groupIds, List<String> ids);

    List<Meeting> findAllByGroupIdInAndOrganizerIdAndTimeStartGreaterThanEqualAndTimeEndLessThanEqual(List<String> groupIds, String userId, Date startDate, Date endDate);

    List<Meeting> findAllByGroupIdInAndAttendeesInAndTimeStartGreaterThanEqualAndTimeEndLessThanEqual(List<String> groupIds, List<String> ids, Date startDate, Date endDate);
