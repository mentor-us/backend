...
public class VoteController {
    ...
    public VoteController(VoteRepository voteRepository, VoteService voteService, SocketIOServer socketServer) {
    ...
    @Operation(
            ...
            description = "Get list of votes in group", tags = "Vote APIs")
    @ApiResponses({
    ...
    @Operation(
            ...
            description = "Get detail information of vote", tags = "Vote APIs")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Get successfully",
                    content = @Content(array = @ArraySchema(schema = @Schema(implementation = APIResponse.class)))
            ),
    ...
    @Operation(
            ...
            description = "Create new vote in group", tags = "Vote APIs")
    @ApiResponses({
    ...
    @Operation(
            summary = "Update vote",
            description = "Update information of vote", tags = "Vote APIs")
    @ApiResponses({
    ...
    @Operation(
            summary = "Delete vote",
            description = "Delete single vote in group", tags = "Vote APIs")
    @ApiResponses({
    ...
    @Operation(
            ...
            tags = "Vote APIs")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Reopen successfully",
                    content = @Content(array = @ArraySchema(schema = @Schema(implementation = APIResponse.class)))
            ),
            @ApiResponse(responseCode = "401", description = "Need authentication"),
    })
    ...
    public ResponseEntity<Void> doVoting(@Parameter(hidden = true) @CurrentUser UserPrincipal user,
        ...
        socketServer.getRoomOperations(vote.getGroupId())
                .sendEvent("receive_voting", vote);
