...
public class GoogleDriveConfig {
  ...
  private static final String CREDENTIALS_FILE_PATH =
      "/credentials.json"; // path file Google Drive Service
  ...
  public static GoogleCredential googleCredential() throws GeneralSecurityException, IOException {
    ...
    GoogleCredential credential =
        new GoogleCredential.Builder()
            ...
            // File("src/main/resources/credentials.p12"))
            .build();
  ...
  public Drive getInstance() throws GeneralSecurityException, IOException {
    ...
    return new Drive.Builder(
            HTTP_TRANSPORT, JacksonFactory.getDefaultInstance(), googleCredential())
        .setApplicationName(APPLICATION_NAME)
        .build();
  }
}
