...
public class TaskController {
    ...
    @Operation(summary = "Retrieve task data", description = "Retrieve fully information of task", tags = "Task APIs")
    @ApiResponses({
            ...
            @ApiResponse(responseCode = TaskReturnCode.NOT_FOUND_GROUP_STRING, description = "Not found group"),
            @ApiResponse(responseCode = TaskReturnCode.NOT_FOUND_PARENT_TASK_STRING, description = "Not found parent task"),
            @ApiResponse(responseCode = TaskReturnCode.NOT_FOUND_USER_IN_GROUP_STRING, description = "Not found user in group"),
    ...
    @Operation(summary = "Add new task", description = "Create new task in a group", tags = "Task APIs")
    @ApiResponses({
    ...
    @Operation(summary = "Update an existing task", description = "Update an existing task with new information", tags = "Task APIs")
    @ApiResponses({
    ...
    @Operation(summary = "Mentee update status of task", description = "Assignees can update status of their own assigned task", tags = "Task APIs")
    @ApiResponses({
    ...
    @Operation(summary = "Mentor update status",
    ...
    @Operation(summary = "Delete an existing task (Only mentor)",
    ...
    @Operation(summary = "Retrieve all tasks of a group (mentor and mentee in group)",
            description = "",
            tags = "Task APIs")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Retrieve successfully",
    ...
    @Operation(summary = "Retrieve all tasks of user",
    ...
    @Operation(summary = "Get your own tasks", description = "Get all tasks that I assigned and have been assigned to me", tags = "Task APIs")
    @ApiResponses({
    ...
    @Operation(summary = "Get your assigned tasks", description = "Get all tasks have been assigned to me", tags = "Task APIs")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Get successfully",
                    content = @Content(
                            array = @ArraySchema(schema = @Schema(implementation = APIResponse.class))
    ...
    @Operation(summary = "Get tasks that you assigned to someone", description = "Get all tasks that I assigned to someone", tags = "Task APIs")
    @ApiResponses({
            @ApiResponse(responseCode = "200", description = "Get successfully",
                    content = @Content(
                            array = @ArraySchema(schema = @Schema(implementation = APIResponse.class))
