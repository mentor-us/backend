...
public class Group implements Serializable {
  ...
  @Builder.Default private List<String> mentors = new ArrayList<>();
  @Builder.Default private List<String> mentees = new ArrayList<>();
  ...
  @Builder.Default private List<String> pinnedMessageIds = new ArrayList<>();
  @Builder.Default private String parentId = null;
  @Builder.Default private List<String> channelIds = new ArrayList<>();
  @Builder.Default private List<String> privateIds = new ArrayList<>();
  @Builder.Default private List<String> faqIds = new ArrayList<>();
  @Builder.Default private String lastMessage = null;
  @Builder.Default private String lastMessageId = null;
  @Builder.Default private List<String> markedMenteeIds = new ArrayList<>();
