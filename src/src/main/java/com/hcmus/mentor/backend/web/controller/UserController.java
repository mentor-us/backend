...
import com.hcmus.mentor.backend.usercase.common.repository.ProfileRepository;
...
public class UserController {
  ...
  public APIResponse<Page<User>> allPaging(
  ...
  @Operation(
      summary = "Retrieve users by email (Paging)",
      description =
          "Retrieve all users information matched with needed email, response will be paged",
      tags = "User APIs")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      summary = "Retrieve all users by email (No paging)",
  ...
  public APIResponse<List<User>> listAllByEmail(
      @Parameter(hidden = true) @CurrentUser UserPrincipal userPrincipal,
      @RequestParam(defaultValue = "") String email) {
    String emailUser = userPrincipal.getEmail();
  ...
  @Operation(
      ...
      description =
          "Account will be deactived after creating, admin need activate account by user id",
      tags = "User APIs")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        ...
        content =
            @Content(
                array =
                    @ArraySchema(
                        schema =
                            @Schema(implementation = UserServiceImpl.UserReturnService.class)))),
  ...
  @Operation(
      summary = "Find users",
      description = "Find users with multiple filters",
      tags = "User APIs")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  @Operation(
      summary = "Get user detail by id(for admin)",
  ...
  @Operation(summary = "Export users table", description = "Export users table", tags = "User APIs")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<Resource> export(
    ...
    ResponseEntity<Resource> response =
        userService.generateExportTable(userPrincipal.getEmail(), remainColumns);
    return response;
  }

  @Operation(
      summary = "Import multiple users",
      description = "Import multiple users by template file",
      tags = "User APIs")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
        ...
        content =
            @Content(array = @ArraySchema(schema = @Schema(implementation = APIResponse.class)))),
    @ApiResponse(
        responseCode = UserReturnCode.INVALID_TEMPLATE_STRING,
        description = "Invalid Template"),
    @ApiResponse(
        responseCode = UserReturnCode.DUPLICATE_USER_STRING,
        description = "User has been duplicated"),
    @ApiResponse(
        responseCode = UserReturnCode.DUPLICATE_USER_STRING,
        description = "User has been duplicated"),
  ...
  public APIResponse<List<Group>> importUsers(
      @Parameter(hidden = true) @CurrentUser UserPrincipal userPrincipal,
  ...
  @Operation(
      summary = "Export mentor groups user table",
      description = "Export mentor groups users table",
      tags = "User APIs")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<Resource> exportMentorGroups(
      ...
      throws IOException {
    ResponseEntity<Resource> response =
        userService.generateExportTableMembers(
            userPrincipal.getEmail(), remainColumns, userId, "MENTOR");
    return response;
  }

  @Operation(
      summary = "Export mentee groups user table",
      description = "Export mentee groups users table",
      tags = "User APIs")
  @ApiResponses({
    @ApiResponse(
        responseCode = "200",
  ...
  public ResponseEntity<Resource> exportMenteeGroups(
    ...
    ResponseEntity<Resource> response =
        userService.generateExportTableMembers(
            userPrincipal.getEmail(), remainColumns, userId, "MENTEE");
    return response;
  }

  @Operation(
      summary = "Export users table by search conditions",
