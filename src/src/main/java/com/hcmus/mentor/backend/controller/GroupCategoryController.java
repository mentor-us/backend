...
public class  GroupCategoryController {
    ...
    @PostMapping
    public APIResponse<GroupCategory> create(@ApiIgnore @CurrentUser UserPrincipal userPrincipal,
    ...
    @PatchMapping("/{id}")
    public APIResponse<GroupCategory> update(@ApiIgnore @CurrentUser UserPrincipal userPrincipal,
