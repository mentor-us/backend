...
public class AuthService {
    ...
    public AuthService(UserRepository userRepository, RefreshTokenRepository refreshTokenRepository, TokenProvider tokenProvider, AppProperties appProperties) {
    ...
    public String generateNewToken(RefreshTokenRequest request) {
        RefreshToken subscription = refreshTokenRepository
                .findFirstByRefreshTokenOrderByIssuedAtDesc(request.getRefreshToken());
