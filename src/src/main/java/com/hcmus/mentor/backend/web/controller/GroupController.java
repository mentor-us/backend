...
import com.hcmus.mentor.backend.usercase.common.service.GroupService.GroupReturnService;
...
public class GroupController {
  ...
  @Operation(
      summary = "Get groups (Paging)",
      description =
          "Get groups based on your role and group type you want\n"
  ...
  @Operation(
      summary = "Get own groups (Paging)",
      description =
          "Get your own groups based on type param\n"
  ...
  @Operation(
      summary = "Get recent groups (Paging)",
  ...
  @Operation(
      summary = "Get existing group by group id",
  ...
  public APIResponse<List<Group>> importGroups(
      @Parameter(hidden = true) @CurrentUser UserPrincipal userPrincipal,
  ...
  public APIResponse<Page<Group>> get(
    ...
    String email = userPrincipal.getEmail();
    GroupReturnService groupReturn =
  ...
  @Operation(
      summary = "Data for Homepage mobile",
      description =
  ...
  @Operation(
      summary = "Enable multiple groups(BE checks time start and time end to generate status)",
      description = "",
      tags = "Group APIs")
  @ApiResponses({
    @ApiResponse(
  ...
  @Operation(
      summary = "Get members of group (Mobile)",
  ...
  @Operation(
      summary = "Get group detail (Mobile)",
  ...
  @Operation(
      summary = "Get group media (Media collection)",
  ...
  @Operation(
      summary = "Update group avatar (Mobile)",
  ...
  public ResponseEntity<Resource> export(
      ...
      throws IOException {
    ResponseEntity<Resource> response =
        groupService.generateExportTable(userPrincipal.getEmail(), remainColumns);
    return response;
  }

  @Operation(
      summary = "Export mentor's group table",
  ...
  public ResponseEntity<Resource> exportMentors(
      ...
      throws IOException {
    ResponseEntity<Resource> response =
        groupService.generateExportTableMembers(
            userPrincipal.getEmail(), remainColumns, groupId, "MENTOR");
    return response;
  }

  @Operation(
      summary = "Export mentee's group table",
  ...
  public ResponseEntity<Resource> exportMentees(
    ...
    ResponseEntity<Resource> response =
        groupService.generateExportTableMembers(
            userPrincipal.getEmail(), remainColumns, groupId, "MENTEE");
    return response;
  }

  @Operation(
      summary = "Pin message (Mobile)",
  ...
  @Operation(
      summary = "Export groups table by search conditions",
  ...
  public ResponseEntity<Resource> exportBySearchConditions(
      ...
      throws IOException {
    ResponseEntity<Resource> response =
        groupService.generateExportTableBySearchConditions(
  ...
  @Operation(
      summary = "Get group workspace (Mobile)",
  ...
  @Operation(
      summary = "Mark mentee in group (Mobile)",
  ...
  @Operation(
      summary = "Unark mentee in group (Mobile)",
