...
public class GroupDetailResponse {
  ...
  public static class GroupChannel {
    ...
    @Builder.Default private List<String> userIds = new ArrayList<>();

    @Builder.Default private Channel.Status status = Channel.Status.ACTIVE;

    @Builder.Default private Channel.Type type = Channel.Type.PUBLIC;
