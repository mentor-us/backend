...
import vn.edu.hcmus.mentor.controller.payload.request.note.CreateNoteRequest;
import vn.edu.hcmus.mentor.controller.payload.request.note.GetNotesByUserRequest;
import vn.edu.hcmus.mentor.controller.payload.request.note.ShareNoteRequest;
import vn.edu.hcmus.mentor.controller.payload.request.note.UpdateNoteRequest;
import vn.edu.hcmus.mentor.controller.usecase.note.common.NoteDetailDto;
import vn.edu.hcmus.mentor.controller.usecase.note.createnote.CreateNoteCommand;
import vn.edu.hcmus.mentor.controller.usecase.note.deletenote.DeleteNoteCommand;
import vn.edu.hcmus.mentor.controller.usecase.note.getnotedetailbyid.GetNoteDetailByIdQuery;
import vn.edu.hcmus.mentor.controller.usecase.note.getnotesbyuserid.GetNoteResult;
import vn.edu.hcmus.mentor.controller.usecase.note.getnotesbyuserid.GetNotesByUserIdQuery;
import vn.edu.hcmus.mentor.controller.usecase.note.searchuserhasnotebyviewer.SearchUserHasNoteByViewerQuery;
import vn.edu.hcmus.mentor.controller.usecase.note.searchuserhasnotebyviewer.SearchUserHasNoteByViewerResult;
import vn.edu.hcmus.mentor.controller.usecase.note.sharenote.ShareNoteCommand;
import vn.edu.hcmus.mentor.controller.usecase.note.updatenote.UpdateNoteCommand;
